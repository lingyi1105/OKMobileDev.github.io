...
function okexChannelDownload(isiOS, channelID) {
    ...
    if (isiOS) {
        ...
        url = "https://hkpublic.oss-accelerate.aliyuncs.com/upgradeapp/OKEx-android.apk";
        window.location.href = url;
    }
    //Google Analytics
    gtag_report_conversion(url);
...
function okexBetaDownload(isiOS, channelID) {
    if (isiOS) {
        ...
        window.location.href = "https://hkpublic.oss-accelerate.aliyuncs.com/upgradeapp/OKEx-android.apk";
    }
}
...
function oknodesBetaDownload(isiOS, channelID) {
    if (isiOS) {
        ...
        window.location.href = "https://hkpublic.oss-accelerate.aliyuncs.com/upgradeapp/OKNodes-android.apk";
    }
}
...
function coinallBetaDownload(isiOS, channelID) {
    if (isiOS) {
        ...
        window.location.href = "https://hkpublic.oss-accelerate.aliyuncs.com/upgradeapp/CoinAll-android.apk";
    }
}
...
function ex99BetaDownload(isiOS, channelID) {
    if (isiOS) {
        ...
        window.location.href = "https://hkpublic.oss-accelerate.aliyuncs.com/upgradeapp/99ex-android.apk";
    }
}
...
function okcoinBetaDownload(isiOS, channelID) {
    if (isiOS) {
        ...
        window.location.href = "https://hkpublic.oss-accelerate.aliyuncs.com/upgradeapp/OKCoin-android.apk";
