new Vue({
    ...
    data: function () {
        return {
            headerName: 'CoinSea',
            headerTitle: 'CoinSea 数字货币交易平台',
            headerSubtitle: '安全便捷 · 优质币种',
            androidInstallTitle: '立即安装 CoinSea',
            betaTitle: '立即安装 CoinSea',
            storeTitle: false,
            logo: './images/header-logo.png',
            androidDownloadURL: 'http://upgradeapp.oss-cn-hangzhou.aliyuncs.com/upgradeapp/coinsea-android.apk',
            tipsData: [{
