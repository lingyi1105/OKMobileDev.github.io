new Vue({
    ...
    data: function () {
        return {
            ...
            install: '点击安装内测版',
            step1Title: "内测版特点",
            creditTitle: '去信任 VVcoin 内测版证书',
            setp_2_tips_1: '安装完成后, 点击下方按钮, 即可授信',
            setp_2_tips_2_1: '下载成功后，请点击',
            setp_2_tips_2_2: '【设置】-【通用】-【设备管理】或 【描述文件与设备管理】',
            setp_2_tips_2_3: '找到 VVcoin 内测版的证书并点击信任，即可使用 VVcoin',
            credit_step_1_img: './images/ios-beta-credit-setp-1.png',
            credit_step_2_img: './images/ios-beta-credit-setp-2.png',
            iosBetaDownloadURL: 'itms-services://?action=download-manifest&url=https://hkpublic.oss-cn-hongkong.aliyuncs.com/upgradeapp/install-vvcoin-manifest.plist',
            tipsData: [
    ...
    methods: {
        handleDownload() {
            ...
            downloadEvent("vvcoin_ios_install_click");
